...
void *communicate( void *ptr)			//int a[M][N])
{
...
//Make everyobject other than the line a 3*3 matrix so that the transpose will work properly
//Glitches :		
// 1. Some of them dont settle down in the right row, but in a row before that..
// 2. The game stops after a while.. (use socket programming)
// 3. S lays eggs.
// 4. 
